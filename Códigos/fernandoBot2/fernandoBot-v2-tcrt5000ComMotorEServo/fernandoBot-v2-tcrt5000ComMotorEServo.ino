...
{
  dMotorA(FRENTE,   vel/2);
  dMotorB(FRENTE, vel);
  tMotorA(FRENTE,   vel/2);
  tMotorB(FRENTE, vel);
}
...
{
  dMotorA(FRENTE, vel);
  dMotorB(FRENTE,   vel/2);
  tMotorA(FRENTE, vel);
  tMotorB(FRENTE,   vel/2);
}
...
/***************************************************************************************
LEDISTANCIA -- retirei, pois demora muito. Praticamente trava o robô...
***************************************************************************************/
int leDistancia()
{
